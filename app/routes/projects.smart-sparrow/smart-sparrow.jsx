        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                Nexora demonstrates end-to-end AI product discovery: semantic and RAG search,
                graph-based recommendations, and production deployment on Google Cloud Run.
                The stack pairs vector retrieval with ranking models to improve relevance and
                reduce search abandonment for large catalogs.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
